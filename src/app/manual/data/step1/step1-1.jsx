...
const Step1_1 = ({ copied, copyToClipboard }) => (
  <div className="space-y-4">
    <h3 className="text-lg font-semibold">입사지원서 작성</h3>
    <p>
      입사지원서 양식은{" "}
      <a
    ...
    <div className="bg-blue-50 p-4 rounded-md">
      <p className="font-medium">아래의 입사지원서 내용을 빠짐없이 꼼꼼히 작성해주시면 됩니다!</p>
      <p className="mt-2">어렵지않죠? 👌</p>
    </div>
    <div className="border p-3 rounded-md">
      <div className="flex items-center justify-between mb-2">
        <h4 className="font-medium">입사지원서 첨부파일</h4>
        <a
