  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-red-50 p-4 rounded-md">
        <h3 className="font-medium mb-2">보장분석 DB사용 전 DB영업 초심자 과제</h3>
        <p className="text-sm">
          모든 과제는{" "}
          <a
      ...
      <div className="border border-gray-200 rounded-md overflow-hidden">
        <div className="bg-red-50 p-3 border-b border-gray-200 flex items-center gap-2">
          ...
          <h3 className="font-medium">과제 목록</h3>
        </div>

        <div className="p-4 space-y-4">
          <div className="flex items-start gap-3 p-3 border rounded-md hover:bg-gray-50 transition-colors">
            <div className="flex-shrink-0 w-8 h-8 bg-red-100 rounded-full flex items-center justify-center text-red-700 font-medium">
              1
            </div>
            <div>
              <h4 className="font-medium text-base mb-1 flex items-center gap-1">
      ...
      <div className="flex flex-col items-center mt-6">
        ...
        >
          ...
          <span className="font-medium">컴패니언 사업부 DB자료 모음</span>
